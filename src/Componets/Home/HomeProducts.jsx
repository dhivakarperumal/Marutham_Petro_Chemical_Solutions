...
const HomeProducts = () => {
  ...
  useEffect(() => {
    if (visibleProducts.length <= 1) return undefined;

    const timer = window.setInterval(() => {
      setSlideIndex((currentIndex) => currentIndex >= visibleProducts.length - 1 ? 0 : currentIndex + 1);
    }, 4200);
  ...
  return (
    <section id="products" className="relative overflow-hidden bg-[#fffaf6] px-[5%] py-20 sm:py-24" aria-labelledby="home-products-title">
      <div className="mx-auto max-w-[1380px]">
        ...
        <div className="overflow-hidden" aria-label="Automatic home product slider">
          <div
