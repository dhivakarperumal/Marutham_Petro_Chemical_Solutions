      ...
      <div className="relative mx-auto grid max-w-[1380px] items-center gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
        <div className="relative min-h-[420px] overflow-hidden rounded-[6px] border border-[#eadfd6] bg-[linear-gradient(145deg,#fff8f2_0%,#fce8d8_100%)] p-5 shadow-[0_20px_45px_rgba(62,35,17,0.08)] sm:min-h-[520px] sm:p-8" data-aos="fade-right" data-aos-duration="850">
          ...
          <img
            ...
            loading="lazy"
          />
          <div className="absolute bottom-7 left-7 z-20 flex items-center gap-3 bg-white px-4 py-3 shadow-[0_12px_28px_rgba(62,35,17,0.14)] sm:left-10" data-aos="zoom-in" data-aos-delay="200">
        ...
        <div className="relative max-w-[650px]" data-aos="fade-left" data-aos-duration="850">
          ...
          <div ref={statsRef} className="mt-8 grid grid-cols-1 gap-2 sm:grid-cols-3" data-aos="zoom-in-up" data-aos-delay="200">
          ...
          <Link to="/about" className="mt-6 inline-flex items-center gap-3 rounded-sm bg-[#d60e1e] px-5 py-3 text-sm font-extrabold text-white shadow-[0_10px_22px_rgba(214,14,30,0.18)] transition hover:bg-[#b90c19]" data-aos="fade-up" data-aos-delay="300">
