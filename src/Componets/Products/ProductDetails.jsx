      ...
      <section className="relative overflow-hidden bg-[linear-gradient(118deg,#fffaf4_0%,#fff_52%,#fff1e6_100%)] px-[5%] py-12 sm:py-20">
        <div className="mx-auto max-w-[1380px]">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
            ...
            <div>
              <div className="mb-4 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-extrabold uppercase tracking-[0.14em] text-[#d94c16]">
                <span>{product.brand}</span>
                <span className="text-[#c7b7ab]">/</span>
                <span>{product.category}</span>
                <span className="text-[#a0968e]">{product.product_id}</span>
              </div>
