    ...
    <main className="bg-[#fffaf6]">
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(118deg,#fffaf4_0%,#fff_52%,#fff1e6_100%)] px-[5%] py-12 sm:py-20">
        <div className="mx-auto max-w-[1380px]">
          <Link to="/products" className="mb-8 inline-flex items-center gap-2 text-sm font-extrabold text-[#766e68] transition hover:text-[#d60e1e]">
          ...
          <div className="grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
            <div>
              ...
              <div className="mb-4 grid grid-cols-3 gap-2 sm:grid-cols-5" aria-label={`${selectedProduct.category} product sizes`}>
                {categoryProducts.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group/thumb rounded-md border bg-white p-2 transition cursor-pointer text-left ${
                        isActive
            ...
            <div className="relative">
              ...
              <h1 className="max-w-[700px] text-[clamp(2.5rem,5vw,5.2rem)] font-extrabold leading-[0.92] tracking-[-0.045em] text-[#2d3035]">{selectedProduct.product_name}</h1>
