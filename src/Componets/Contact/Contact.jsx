        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-5 sm:p-6 flex gap-4 items-start border border-gray-100" data-aos="zoom-in-up" data-aos-delay="300">
            ...
            <div>
              ...
              <a href="#contact-form" className="text-[#fb5921] text-sm font-bold mt-2 inline-flex items-center hover:underline">Get a Quote &rarr;</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div id="contact-form" className="bg-white rounded-2xl p-5 sm:p-8 border border-gray-100 shadow-sm" data-aos="fade-right" data-aos-duration="850">
            ...
            <form className="space-y-4 sm:space-y-5">
              ...
              <button type="submit" className="bg-gradient-to-r from-[#fb5921] to-[#e41a15] hover:from-[#e41a15] hover:to-[#c61410] text-white font-medium py-3 px-8 rounded-md flex items-center justify-center transition-all shadow-md mt-2 w-full sm:w-fit cursor-pointer">
